...
|---|--:|--:|--:|--:|--:|
| fib | 1018.0 M | 938.0 M | 635.7 M | 1.09x | 1.60x |
| mandelbrot | 2140.8 M | 1646.8 M | 1612.4 M | 1.30x | 1.33x |
| collatz | 920.6 M | 628.4 M | 412.8 M | 1.46x | 2.23x |
| alloc | 987.4 M | 398.0 M | 621.6 M | 2.48x | 1.59x |
| allocflat | 257.7 M | 127.5 M | 18.2 M | 2.02x | 14.17x |
| strings | 951.1 M | 375.5 M | 109.9 M | 2.53x | 8.65x |
| map | 321.2 M | 403.5 M | 173.0 M | 0.80x | 1.86x |
| strmap | 1320.7 M | 689.4 M | 260.5 M | 1.92x | 5.07x |
| sort | 315.5 M | 359.3 M | 284.9 M | 0.88x | 1.11x |
| matrix | 1384.9 M | 954.4 M | 399.6 M | 1.45x | 3.47x |
| json | 1376.7 M | 343.7 M | 234.3 M | 4.01x | 5.88x |

### Instructions retired: work emitted, not time taken

| Benchmark | Bit | Go | C |
|---|--:|--:|--:|
| fib | 5962.7 M | 5137.0 M | 3146.8 M |
| mandelbrot | 4790.1 M | 2507.5 M | 2699.9 M |
| collatz | 2579.3 M | 935.6 M | 930.7 M |
| alloc | 7549.3 M | 2157.6 M | 4287.8 M |
| allocflat | 1602.9 M | 405.2 M | 59.3 M |
| strings | 7061.5 M | 1704.2 M | 643.4 M |
| map | 748.7 M | 693.4 M | 229.3 M |
| strmap | 6427.3 M | 2212.2 M | 540.0 M |
| sort | 1881.3 M | 943.2 M | 508.8 M |
| matrix | 12280.2 M | 7323.9 M | 1656.3 M |
| json | 9260.3 M | 2127.9 M | 1372.0 M |
...
| alloc | 6.1 MB | 10.3 MB | 1.6 MB |
| allocflat | 5.7 MB | 10.8 MB | 1.5 MB |
| strings | 134.2 MB | 68.9 MB | 30.7 MB |
...
| mandelbrot | 6 | 194 | 0 |
| collatz | 6 | 194 | 0 |
| alloc | 10006006 | 10002317 | 10004000 |
| allocflat | 4006 | 2286 | 2000 |
| strings | 7125035 | 336 | 11 |
| map | 14 | 4372 | 1 |
| strmap | 400041 | 400808 | 400003 |
| sort | 600022 | 150280 | 150002 |
| matrix | 16 | 277 | 3 |
| json | 5400061 | 1050001 | 2250021 |
...
| Metric | Bit | Go | C |
|---|--:|--:|--:|
| Process startup (per exec) | 4.595 ms | 17.696 ms | 4.193 ms |

Bit compile speed: **660 lines/sec** (669 lines across 11 cases, warm).

> Machine: Apple M5 Max, macOS 26.6.2. Bit @ `a24594ac`, Go go1.27.1, Apple clang version 21.0.0 (clang-2100.1.1.101).
...
> Peak RSS above is a within-run median like every other figure in that table, but it can still swing further ACROSS separate regenerations than one run shows (#4199). From every regeneration recorded in `bench/history.csv`, restricted to the same four loose rows above and to the Go/C columns (the Bit column reflects real compiler/runtime changes over that history, not noise): `alloc` c: 1.5-1.7 MB (median 1.6 MB, N=23); `strings` go: 64.3-90.9 MB (median 69.0 MB, N=20). Read that cell's published number as representative of the stated range, not a fixed constant.
...
> Generated by `bench/run.sh` on 2026-09-14T21:14:19Z. Do not edit by hand.
<!-- BENCH:END -->
