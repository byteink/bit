...
|---|--:|--:|--:|--:|--:|
| fib | 1008.5 M | 947.9 M | 632.3 M | 1.06x | 1.59x |
| mandelbrot | 2133.8 M | 1638.4 M | 1605.9 M | 1.30x | 1.33x |
| collatz | 917.8 M | 626.3 M | 411.1 M | 1.47x | 2.23x |
| alloc | 989.9 M | 389.8 M | 469.2 M | 2.54x | 2.11x |
| allocflat | 256.9 M | 119.0 M | 18.2 M | 2.16x | 14.10x |
| allocpar | 11957.8 M | 1260.8 M | 2156.6 M | 9.48x | 5.54x |
| strings | 211.4 M | 354.9 M | 109.1 M | 0.60x | 1.94x |
| map | 297.3 M | 375.4 M | 174.9 M | 0.79x | 1.70x |
| strmap | 1266.4 M | 676.9 M | 248.7 M | 1.87x | 5.09x |
| sort | 293.7 M | 357.9 M | 278.4 M | 0.82x | 1.05x |
| matrix | 1379.6 M | 951.9 M | 398.7 M | 1.45x | 3.46x |
| json | 888.2 M | 338.2 M | 226.5 M | 2.63x | 3.92x |

### Instructions retired: work emitted, not time taken

| Benchmark | Bit | Go | C |
|---|--:|--:|--:|
| fib | 5962.6 M | 5137.1 M | 3146.7 M |
| mandelbrot | 4788.5 M | 2506.4 M | 2698.8 M |
| collatz | 2578.8 M | 935.3 M | 930.4 M |
| alloc | 7612.1 M | 2152.3 M | 3606.8 M |
| allocflat | 1604.5 M | 405.0 M | 59.3 M |
| allocpar | 13332.6 M | 4578.1 M | 3620.9 M |
| strings | 1689.2 M | 1679.2 M | 643.4 M |
| map | 748.5 M | 693.6 M | 229.4 M |
| strmap | 6207.2 M | 2206.8 M | 534.2 M |
| sort | 1795.7 M | 943.0 M | 503.7 M |
| matrix | 12279.4 M | 7323.6 M | 1656.1 M |
| json | 5921.2 M | 2135.8 M | 1339.8 M |
...
| mandelbrot | 6 | 196 | 0 |
| collatz | 6 | 196 | 0 |
| alloc | 10006006 | 10002325 | 10004000 |
| allocflat | 4006 | 2303 | 2000 |
| allocpar | 10006053 | 10002432 | 10004000 |
| strings | 37 | 340 | 11 |
| map | 14 | 4380 | 1 |
...
| Metric | Bit | Go | C |
|---|--:|--:|--:|
| Process startup (per exec) | 4.372 ms | 4.764 ms | 4.229 ms |

Bit compile speed: **661 lines/sec** (769 lines across 12 cases, warm).

> Machine: Apple M5 Max, macOS 27.0. Bit @ `1b1c2bc50`, Go go1.27.1, Apple clang version 21.0.0 (clang-2100.3.34.2).
...
> Cycles and instructions are startup-corrected: each figure has that language's own empty-program cost (`bench/cases/startup`, bit 4.9M, c 3.9M, go 6.0M) subtracted, because dyld and runtime init differ per language and are a fifth of C's `allocflat` row. Every other table is raw.
...
> Peak RSS above is a within-run median like every other figure in that table, but it can still swing further ACROSS separate regenerations than one run shows. From every regeneration recorded in `bench/history.csv`, restricted to the same four loose rows above and to the Go/C columns (the Bit column reflects real compiler/runtime changes over that history, not noise): `alloc` c: 1.5-2.0 MB (median 1.6 MB, N=35); `allocflat` go: 10.6-12.0 MB (median 11.3 MB, N=26); `allocflat` c: 1.5-1.9 MB (median 1.5 MB, N=26); `strings` go: 64.3-90.9 MB (median 73.1 MB, N=32). Read that cell's published number as representative of the stated range, not a fixed constant.
...
> Generated by `bench/run.sh` on 2026-09-23T15:15:41Z. Do not edit by hand.
<!-- BENCH:END -->
