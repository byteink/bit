...
|---|--:|--:|--:|--:|--:|
| fib | 1018.6 M | 944.0 M | 634.6 M | 1.08x | 1.61x |
| mandelbrot | 2131.0 M | 1636.7 M | 1604.0 M | 1.30x | 1.33x |
| collatz | 917.6 M | 625.8 M | 410.9 M | 1.47x | 2.23x |
| alloc | 970.8 M | 387.3 M | 462.0 M | 2.51x | 2.10x |
| allocflat | 258.3 M | 114.1 M | 17.9 M | 2.26x | 14.46x |
| strings | 964.8 M | 369.6 M | 109.2 M | 2.61x | 8.83x |
| map | 336.4 M | 409.0 M | 179.9 M | 0.82x | 1.87x |
| strmap | 1300.2 M | 673.2 M | 251.5 M | 1.93x | 5.17x |
| sort | 301.3 M | 357.3 M | 278.9 M | 0.84x | 1.08x |
| matrix | 1379.4 M | 951.8 M | 398.5 M | 1.45x | 3.46x |
| json | 1153.8 M | 341.5 M | 227.4 M | 3.38x | 5.07x |

### Instructions retired: work emitted, not time taken

| Benchmark | Bit | Go | C |
|---|--:|--:|--:|
| fib | 5962.5 M | 5137.0 M | 3146.7 M |
| mandelbrot | 4788.4 M | 2506.4 M | 2698.7 M |
| collatz | 2578.8 M | 935.4 M | 930.5 M |
| alloc | 7600.4 M | 2157.4 M | 3606.8 M |
| allocflat | 1604.6 M | 404.4 M | 59.3 M |
| strings | 7103.8 M | 1706.7 M | 643.4 M |
| map | 748.7 M | 693.7 M | 229.6 M |
| strmap | 6390.3 M | 2193.1 M | 534.3 M |
| sort | 1851.0 M | 943.1 M | 503.6 M |
| matrix | 12279.4 M | 7323.7 M | 1656.1 M |
| json | 7716.9 M | 2141.5 M | 1340.1 M |

### Wall clock: median of 15 runs, context only

| Benchmark | Bit | Go | C |
|---|--:|--:|--:|
| fib | 0.240s | 0.220s | 0.150s |
| mandelbrot | 0.490s | 0.370s | 0.370s |
| collatz | 0.200s | 0.130s | 0.090s |
| alloc | 0.220s | 0.080s | 0.100s |
| allocflat | 0.060s | 0.020s | 0.000s |
| strings | 0.220s | 0.060s | 0.020s |
| map | 0.080s | 0.090s | 0.040s |
| strmap | 0.300s | 0.150s | 0.060s |
| sort | 0.070s | 0.080s | 0.060s |
| matrix | 0.320s | 0.220s | 0.090s |
| json | 0.270s | 0.070s | 0.050s |
...
| map | 14 | 4379 | 1 |
| strmap | 400041 | 400811 | 400003 |
| sort | 600022 | 150280 | 150002 |
| matrix | 16 | 279 | 3 |
| json | 3750060 | 1049994 | 2250021 |

### Binary size: static, as emitted

| Benchmark | Bit | Go | C |
|---|--:|--:|--:|
| fib | 269 KB | 2373 KB | 33 KB |
...
| Metric | Bit | Go | C |
|---|--:|--:|--:|
| Process startup (per exec) | 4.536 ms | 5.056 ms | 4.443 ms |

Bit compile speed: **655 lines/sec** (669 lines across 11 cases, warm).

> Machine: Apple M5 Max, macOS 27.0. Bit @ `2bef5d2c`, Go go1.27.1, Apple clang version 21.0.0 (clang-2100.3.34.2).
...
> Cycles and instructions are startup-corrected: each figure has that language's own empty-program cost (`bench/cases/startup`, bit 5.1M, c 4.4M, go 6.3M) subtracted, because dyld and runtime init differ per language and are a fifth of C's `allocflat` row. Every other table is raw.
...
> Peak RSS above is a within-run median like every other figure in that table, but it can still swing further ACROSS separate regenerations than one run shows (#4199). From every regeneration recorded in `bench/history.csv`, restricted to the same four loose rows above and to the Go/C columns (the Bit column reflects real compiler/runtime changes over that history, not noise): `alloc` c: 1.5-2.0 MB (median 1.6 MB, N=27); `allocflat` c: 1.5-1.9 MB (median 1.5 MB, N=18); `strings` go: 64.3-90.9 MB (median 69.2 MB, N=24). Read that cell's published number as representative of the stated range, not a fixed constant.
...
> Generated by `bench/run.sh` on 2026-09-18T22:59:28Z. Do not edit by hand.
<!-- BENCH:END -->
