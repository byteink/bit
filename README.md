...
|---|--:|--:|--:|--:|--:|
| fib | 1023.8 M | 938.4 M | 636.6 M | 1.09x | 1.61x |
| mandelbrot | 2130.8 M | 1638.5 M | 1604.7 M | 1.30x | 1.33x |
| collatz | 917.6 M | 624.7 M | 411.2 M | 1.47x | 2.23x |
| alloc | 983.7 M | 395.2 M | 464.5 M | 2.49x | 2.12x |
| allocflat | 256.2 M | 121.8 M | 18.2 M | 2.10x | 14.07x |
| strings | 956.2 M | 381.2 M | 109.0 M | 2.51x | 8.77x |
| map | 335.8 M | 420.9 M | 179.4 M | 0.80x | 1.87x |
| strmap | 1282.6 M | 683.1 M | 256.9 M | 1.88x | 4.99x |
| sort | 295.3 M | 358.6 M | 277.9 M | 0.82x | 1.06x |
| matrix | 1381.2 M | 951.0 M | 397.9 M | 1.45x | 3.47x |
| json | 881.0 M | 342.3 M | 227.4 M | 2.57x | 3.87x |

### Instructions retired: work emitted, not time taken

| Benchmark | Bit | Go | C |
|---|--:|--:|--:|
| fib | 5962.8 M | 5137.1 M | 3146.6 M |
| mandelbrot | 4789.0 M | 2506.7 M | 2698.8 M |
| collatz | 2579.1 M | 935.6 M | 930.6 M |
| alloc | 7601.5 M | 2157.0 M | 3606.7 M |
| allocflat | 1604.4 M | 407.0 M | 59.2 M |
| strings | 7103.4 M | 1720.5 M | 643.4 M |
| map | 748.7 M | 693.9 M | 229.2 M |
| strmap | 6216.8 M | 2212.8 M | 534.2 M |
| sort | 1791.4 M | 943.1 M | 503.6 M |
| matrix | 12279.9 M | 7323.9 M | 1656.1 M |
| json | 5877.0 M | 2133.5 M | 1339.8 M |
...
| allocflat | 6.1 MB | 11.4 MB | 1.9 MB |
...
| Metric | Bit | Go | C |
|---|--:|--:|--:|
| Process startup (per exec) | 4.492 ms | 4.903 ms | 4.126 ms |

Bit compile speed: **653 lines/sec** (669 lines across 11 cases, warm).

> Machine: Apple M5 Max, macOS 27.0. Bit @ `86a5e862`, Go go1.27.1, Apple clang version 21.0.0 (clang-2100.3.34.2).
...
> Cycles and instructions are startup-corrected: each figure has that language's own empty-program cost (`bench/cases/startup`, bit 4.8M, c 4.0M, go 6.1M) subtracted, because dyld and runtime init differ per language and are a fifth of C's `allocflat` row. Every other table is raw.
...
> Peak RSS above is a within-run median like every other figure in that table, but it can still swing further ACROSS separate regenerations than one run shows. From every regeneration recorded in `bench/history.csv`, restricted to the same four loose rows above and to the Go/C columns (the Bit column reflects real compiler/runtime changes over that history, not noise): `alloc` c: 1.5-2.0 MB (median 1.6 MB, N=28); `allocflat` c: 1.5-1.9 MB (median 1.5 MB, N=19); `strings` go: 64.3-90.9 MB (median 69.3 MB, N=25). Read that cell's published number as representative of the stated range, not a fixed constant.
...
> Generated by `bench/run.sh` on 2026-09-19T20:52:51Z. Do not edit by hand.
<!-- BENCH:END -->
