...
|---|--:|--:|--:|--:|--:|
| fib | 1024.0 M | 950.8 M | 637.6 M | 1.08x | 1.61x |
| mandelbrot | 2128.6 M | 1638.8 M | 1606.1 M | 1.30x | 1.33x |
| collatz | 912.7 M | 626.8 M | 411.6 M | 1.46x | 2.22x |
| alloc | 1537.8 M | 390.7 M | 636.5 M | 3.94x | 2.42x |
| allocflat | 296.5 M | 117.6 M | 17.4 M | 2.52x | 17.07x |
| strings | 1396.7 M | 378.2 M | 108.7 M | 3.69x | 12.85x |
| map | 461.4 M | 397.1 M | 171.2 M | 1.16x | 2.70x |
| sort | 520.0 M | 357.7 M | 282.7 M | 1.45x | 1.84x |
| matrix | 3397.0 M | 952.1 M | 398.1 M | 3.57x | 8.53x |
| json | 1907.2 M | 339.2 M | 234.7 M | 5.62x | 8.13x |

### Instructions retired: work emitted, not time taken

| Benchmark | Bit | Go | C |
|---|--:|--:|--:|
| fib | 5962.6 M | 5136.6 M | 3146.7 M |
| mandelbrot | 5004.4 M | 2506.1 M | 2698.8 M |
| collatz | 2846.8 M | 935.1 M | 930.6 M |
| alloc | 11489.9 M | 2156.5 M | 4287.4 M |
| allocflat | 2104.3 M | 401.6 M | 59.3 M |
| strings | 10333.3 M | 1725.8 M | 643.4 M |
| map | 1182.6 M | 692.9 M | 229.1 M |
| sort | 2874.2 M | 942.7 M | 508.6 M |
| matrix | 22755.6 M | 7323.5 M | 1656.2 M |
| json | 12826.0 M | 2132.6 M | 1374.6 M |
...
| mandelbrot | 0.490s | 0.360s | 0.350s |
| collatz | 0.200s | 0.140s | 0.090s |
| alloc | 0.360s | 0.080s | 0.140s |
| allocflat | 0.060s | 0.010s | 0.000s |
| strings | 0.320s | 0.050s | 0.020s |
...
| Metric | Bit | Go | C |
|---|--:|--:|--:|
| Process startup (per exec) | 3.673 ms | 4.071 ms | 3.455 ms |

Bit compile speed: **341 lines/sec** (519 lines across 10 cases, warm).

> Machine: Apple M5 Max, macOS 26.6.2. Bit @ `388eb7e2`, Go go1.27.1, Apple clang version 21.0.0 (clang-2100.1.1.101).
...
> Cycles and instructions are startup-corrected: each figure has that language's own empty-program cost (`bench/cases/startup`, bit 4.6M, c 3.9M, go 5.9M) subtracted, because dyld and runtime init differ per language and are a fifth of C's `allocflat` row. Every other table is raw.
...
> Peak RSS above is a within-run median like every other figure in that table, but it can still swing further ACROSS separate regenerations than one run shows (#4199). From every regeneration recorded in `bench/history.csv`, restricted to the same four loose rows above and to the Go/C columns (the Bit column reflects real compiler/runtime changes over that history, not noise): `alloc` c: 1.5-1.7 MB (median 1.6 MB, N=14); `strings` go: 64.3-90.9 MB (median 68.9 MB, N=11). Read that cell's published number as representative of the stated range, not a fixed constant.
...
> Generated by `bench/run.sh` on 2026-09-06T00:33:47Z. Do not edit by hand.
<!-- BENCH:END -->
