...
fn emitTranslated(
    ...
    switch (d) {
        ...
        .stackmaps_addr => |sa| remap[idx] = try bldr.stackMapsAddr(ty, sa.which),
        .rt_call => |rc| {
...
fn markOperandsLive(f: *const ir.Function, live: []bool, id: ir.ValueId) void {
    switch (f.decode(id)) {
        .block_param, .const_int, .const_float, .const_bool, .const_string, .const_nil, .unreachable_, .gc_alloc, .type_info, .func_addr, .global_addr, .stackmaps_addr => {},
        .bin => |b| {
