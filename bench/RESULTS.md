...
|---|--:|--:|--:|--:|--:|
| fib | 1009.9 M | 937.8 M | 637.4 M | 1.08x | 1.58x |
| mandelbrot | 2133.8 M | 1638.0 M | 1605.0 M | 1.30x | 1.33x |
| collatz | 917.5 M | 626.4 M | 411.2 M | 1.46x | 2.23x |
| alloc | 976.2 M | 401.0 M | 643.2 M | 2.43x | 1.52x |
| allocflat | 254.8 M | 119.0 M | 17.8 M | 2.14x | 14.34x |
| strings | 939.8 M | 365.7 M | 109.3 M | 2.57x | 8.60x |
| map | 305.9 M | 383.4 M | 174.3 M | 0.80x | 1.76x |
| strmap | 1312.0 M | 678.3 M | 255.1 M | 1.93x | 5.14x |
| sort | 304.6 M | 356.8 M | 285.7 M | 0.85x | 1.07x |
| matrix | 1380.1 M | 950.6 M | 398.0 M | 1.45x | 3.47x |
| json | 1354.2 M | 337.4 M | 231.8 M | 4.01x | 5.84x |
...
| collatz | 2578.9 M | 935.3 M | 930.5 M |
| alloc | 7548.3 M | 2150.2 M | 4287.3 M |
| allocflat | 1602.8 M | 400.5 M | 59.3 M |
| strings | 7061.4 M | 1696.8 M | 643.3 M |
| map | 748.5 M | 693.4 M | 229.2 M |
| strmap | 6444.5 M | 2218.4 M | 539.8 M |
| sort | 1880.9 M | 942.7 M | 508.6 M |
| matrix | 12279.7 M | 7323.5 M | 1656.2 M |
| json | 9264.0 M | 2135.8 M | 1371.6 M |
...
| json | 179.0 MB | 55.8 MB | 125.2 MB |
...
| Metric | Bit | Go | C |
|---|--:|--:|--:|
| Process startup (per exec) | 4.262 ms | 4.669 ms | 4.322 ms |

Bit compile speed: **675 lines/sec** (669 lines across 11 cases, warm).

> Machine: Apple M5 Max, macOS 26.6.2. Bit @ `d3a6834d`, Go go1.27.1, Apple clang version 21.0.0 (clang-2100.1.1.101).
...
> Peak RSS above is a within-run median like every other figure in that table, but it can still swing further ACROSS separate regenerations than one run shows (#4199). From every regeneration recorded in `bench/history.csv`, restricted to the same four loose rows above and to the Go/C columns (the Bit column reflects real compiler/runtime changes over that history, not noise): `alloc` c: 1.5-1.7 MB (median 1.6 MB, N=22); `strings` go: 64.3-90.9 MB (median 69.0 MB, N=19). Read that cell's published number as representative of the stated range, not a fixed constant.
...
> Generated by `bench/run.sh` on 2026-09-14T15:46:16Z. Do not edit by hand.
