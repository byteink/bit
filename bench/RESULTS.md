...
|---|--:|--:|--:|--:|--:|
| fib | 1025.8 M | 948.2 M | 638.0 M | 1.08x | 1.61x |
| mandelbrot | 2132.4 M | 1638.0 M | 1605.0 M | 1.30x | 1.33x |
| collatz | 913.6 M | 625.6 M | 411.0 M | 1.46x | 2.22x |
| alloc | 1154.4 M | 392.9 M | 636.7 M | 2.94x | 1.81x |
| allocflat | 249.6 M | 121.1 M | 17.6 M | 2.06x | 14.18x |
| strings | 1059.5 M | 379.4 M | 108.7 M | 2.79x | 9.74x |
| map | 325.5 M | 399.0 M | 170.8 M | 0.82x | 1.91x |
| strmap | 1289.6 M | 675.5 M | 252.2 M | 1.91x | 5.11x |
| sort | 321.5 M | 356.0 M | 283.7 M | 0.90x | 1.13x |
| matrix | 1381.2 M | 951.0 M | 397.2 M | 1.45x | 3.48x |
| json | 1795.2 M | 339.5 M | 229.3 M | 5.29x | 7.83x |

### Instructions retired: work emitted, not time taken

| Benchmark | Bit | Go | C |
|---|--:|--:|--:|
| fib | 5962.3 M | 5136.7 M | 3146.5 M |
| mandelbrot | 4792.7 M | 2506.0 M | 2698.7 M |
| collatz | 2578.8 M | 935.1 M | 930.5 M |
| alloc | 8014.9 M | 2150.5 M | 4287.4 M |
| allocflat | 1660.3 M | 402.3 M | 59.3 M |
| strings | 7463.4 M | 1722.8 M | 643.3 M |
| map | 803.0 M | 692.9 M | 229.0 M |
| strmap | 6458.1 M | 2199.3 M | 539.7 M |
| sort | 1965.0 M | 942.6 M | 508.6 M |
| matrix | 12279.9 M | 7323.4 M | 1656.1 M |
| json | 12290.4 M | 2133.4 M | 1371.6 M |
...
| allocflat | 4006 | 2293 | 2000 |
| strings | 7125035 | 344 | 11 |
| map | 14 | 4377 | 1 |
| strmap | 400041 | 400796 | 400003 |
| sort | 600022 | 150284 | 150002 |
| matrix | 16 | 284 | 3 |
| json | 5400062 | 1049992 | 2250021 |
...
| Metric | Bit | Go | C |
|---|--:|--:|--:|
| Process startup (per exec) | 3.694 ms | 4.164 ms | 3.456 ms |

Bit compile speed: **565 lines/sec** (669 lines across 11 cases, warm).

> Machine: Apple M5 Max, macOS 26.6.2. Bit @ `d1534308`, Go go1.27.1, Apple clang version 21.0.0 (clang-2100.1.1.101).
...
> Cycles and instructions are startup-corrected: each figure has that language's own empty-program cost (`bench/cases/startup`, bit 4.8M, c 3.9M, go 5.8M) subtracted, because dyld and runtime init differ per language and are a fifth of C's `allocflat` row. Every other table is raw.
...
> Peak RSS above is a within-run median like every other figure in that table, but it can still swing further ACROSS separate regenerations than one run shows (#4199). From every regeneration recorded in `bench/history.csv`, restricted to the same four loose rows above and to the Go/C columns (the Bit column reflects real compiler/runtime changes over that history, not noise): `alloc` c: 1.5-1.7 MB (median 1.6 MB, N=17); `strings` go: 64.3-90.9 MB (median 68.9 MB, N=14). Read that cell's published number as representative of the stated range, not a fixed constant.
...
> Generated by `bench/run.sh` on 2026-09-08T00:23:37Z. Do not edit by hand.
