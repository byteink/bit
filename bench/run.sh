...
md="$WORK/results.md"
{
  ...
  echo
  echo "### Wall clock: median of ${RUNS} runs, milliseconds, context only"
  echo
  echo "| Benchmark | Bit | Go | C |"
  echo "|---|--:|--:|--:|"
  for c in $CASES; do
