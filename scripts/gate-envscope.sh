...
# The fifth assertion lives in its own file (test-shellsize's 800-line
# ceiling). Sourced here so every caller of
# assert_taskwordssizing_scope_current() is unaffected.
. "$(dirname "${BASH_SOURCE[0]}")/gate-taskwordsscope.sh"
