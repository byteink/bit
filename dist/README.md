...
component at all: the compiler is bootstrapped by the pinned stage0
(`dist/stage0/SHA256SUMS`), which is a prior Bit release rather than a
third-party component. The document states the
